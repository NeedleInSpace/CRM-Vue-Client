            ...
            <div id = "addCompany-layout">
                <div id = "addCompany-header">
                    ...
                    <div id = "companyName-field">
                        <input v-model.lazy.trim = "company.name" id = "companyName-input"
                ...
                <div id = "fields-layout">
                    <div id = "companyFullName-layout" class = "companyField">
                        ...
                        <div class = "fieldBorder">
                            <input v-model.lazy.trim = "company.fullName"
                            class = "fieldContent" placeholder = "Полное название" />
                        </div>
                    </div>
                    <div id = "companyActivity-layout" class = "companyField">
                        <div id = "companyActivity" class = "fieldTitle">Род деятельности</div>
                        <div class = "fieldBorder">
                            <input v-model.lazy.trim = "company.kindOfActivity"
                            class = "fieldContent" placeholder = "Род деятельности" />
                        </div>
                    </div>
                    ...
                    <div id = "generatingCapacity-layout" class = "companyField">
                        ...
                        <input v-model = "company.generatingCapacity" type="checkbox"
                        class = "fieldContent" id = "generatingCapacity-checkbox"/>
                    </div>
                    <div id = "inn-layout" class = "companyField">
                        <div id = "inn" class = "fieldTitle">ИНН</div>
                        <div id = "innFieldBorder" class = "fieldBorder">
                            <input v-model.lazy.trim = "company.inn" type = "number"
                            id = "innFieldContent" class = "fieldContent" placeholder = "ИНН" />
                        </div>
                    </div>
                    <div id = "kpp-layout" class = "companyField">
                        <div id = "kpp" class = "fieldTitle">КПП</div>
                        <div id = "kppFieldBorder" class = "fieldBorder">
                            <input v-model.lazy.trim = "company.kpp" type = "number"
                            id = "kppFieldContent" class = "fieldContent" placeholder = "КПП" />
                        </div>
                    </div>
                    <div id = "okpo-layout" class = "companyField">
                        <div id = "okpo" class = "fieldTitle">ОКПО</div>
                        <div id = "okpoFieldBorder" class = "fieldBorder">
                            <input v-model.lazy.trim = "company.okpo" type = "number"
                            id = "okpoFieldContent" class = "fieldContent" placeholder = "ОКПО" />
                        </div>
                    </div>
                    <div id = "email-layout" class = "companyField">
                        <div id = "companyActivity" class = "fieldTitle">E-mail</div>
                        <div class = "fieldBorder">
                            <input v-model.lazy.trim = "company.email"
                            class = "fieldContent" placeholder = "E-mail" />
                        </div>
                    </div>
                    <div id = "phone-layout" class = "companyField">
                        ...
                        <div class = "fieldBorder">
                            ...
                            class = "fieldContent" placeholder = "Телефон" />
                        </div>
                    </div>
                </div>
...
export default class Company extends Vue {
  onAddButtonClick() {
    ...
    store.dispatch('POST_NEW_COMPANY', [this.company]);
  }
    ...
    options = [
      {
        text: 'Неизвестно', value: null,
      },
      {
        text: '< 1 МВт', value: null,
      },
      {
        text: '1 МВт - 2 МВт', value: null,
      },
      {
        text: '2 МВт - 3 МВт', value: null,
      },
    ]
...
#body {
    ...
    #fields-layout {
        ...
        #innFieldBorder, #kppFieldBorder, #okpoFieldBorder {
            width: 108px;
        }

        #innFieldContent, #kppFieldContent, #okpoFieldContent {
            width: 95px;
        }
    ...
    #buttons-layout {
        ...
        #addCompanyButton-layout:active, #addCompanyButton-layout:focus {
            outline: none;
        }
